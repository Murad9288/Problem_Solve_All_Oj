...
//}
//
//let hd = Resulation(height: 1080, width: 1920)
//var cinema = hd
//cinema.width = 2048
//print(hd.height)
//
...
//
//
//var array = Array(repeating: 2, count: 4)
//print(array)
//
...
//
//print("OddDigits and evenDigits UinonSet = \(oddDigits.union(evenDigits).sorted())")
//
//print("OddDigits and evenDigits Intersection = \(oddDigits.intersection(evenDigits).sorted())")
//
//print("OddDigits and evenDigits Substracting = \(oddDigits.subtracting(primeDigits).sorted())")
//
//print("OddDigits and evenDigits symmetricDifference = \(oddDigits.symmetricDifference(primeDigits).sorted())")
//
...
//let minute = 60
//let minute_step = 5
//for i in stride(from: 0, through: minute, by: minute_step){
//    print(i)
//}
//
//
